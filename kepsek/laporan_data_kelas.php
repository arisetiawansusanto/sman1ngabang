                                                ...
                                                <tbody>
                                                    ...
                                                    <?php while ($data = mysqli_fetch_array($dt)) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo $data['Jumlah_Murid']; ?>
                                                            </td>
                                                            <td>
                                                                <a href="../kepsek/cetak_kelas.php?kelas=<?php echo $data['ID_Kelas']; ?>" target="blank" class="btn btn-success float-right text-dark"> Cetak Laporan Kelas</a>
                                                            </td>
                                                        </tr>
                                                    <?php $no++;
                                                    } ?>
