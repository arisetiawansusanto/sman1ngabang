                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Data Nilai Murid</h2>
                                        ...
                                        <table class="table">
                                            ...
                                            <thead class="bg-light">
                                                <tr class="border-0">
                                                    ...
                                                    <th class="border-0">Pengetahuan</th>
                                                    <th class="border-0">Keterampilan</th>
                                            ...
                                            <tbody>
                                                ...
                                                <?php while ($data = mysqli_fetch_array($dt)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="../guru/edit_nilai_murid.php?id=<?php echo $data['ID_Nilai']; ?>" class="btn btn-primary float-right">Edit</a>
                                                            <a href="../config/cNilai.php?hapusNilai=<?php echo $data['ID_Nilai']; ?>" class="btn btn-danger float-right">Hapus</a>
                                                        </td>
                                                    </tr>
                                                <?php $no++;
                                                } ?>
                                                <tr>
                                                    <td colspan="12">
                                                        <a href="input_nilai_murid.php" class="btn btn-success float-right text-dark"><i class="fa fas fa-plus"></i> Tambah Nilai</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
