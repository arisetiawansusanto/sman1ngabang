...
$pdf->Cell(5, 5, ':', 0, 0, 'L');
$pdf->Cell(30, 5, get_murid($db, $_GET['id'], 'id'), 0, 1, 'L');
...
$pdf->Cell(5, 5, ':', 0, 0, 'L');
$pdf->Cell(30, 5, get_murid($db, $_GET['id'], 'kelas'), 0, 1, 'L');

$tahun = get_registrasi2($db, $_GET['id'], 'tahun') + 1;
$pdf->SetFont('Times', '', 10);
$pdf->Cell(10, 5, '', 0, 0, '');
$pdf->Cell(30, 5, 'Tahun Ajaran', 0, 0, 'L');
$pdf->Cell(5, 5, ':', 0, 0, 'L');
$pdf->Cell(8, 5, get_akademik($db, $regis, 'semester'), 0, 0, 'L');
$pdf->Cell(2, 5, '/', 0, 0, 'L');
$pdf->Cell(8, 5, get_akademik($db, $regis, 'tahun'), 0, 1, 'L');
