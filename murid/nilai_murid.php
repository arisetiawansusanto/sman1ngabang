                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table">
                                            <!-- panggil query -->
                                            <?php $dt = get_detailnilai($db, $_SESSION['Akunlogin']);
                                            $no = 1 ?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="12">
                                                        <a href="../murid/cetak_laporan_nilai_murid.php?id=<?php echo $_SESSION['Akunlogin']; ?>" target="blank" class="btn btn-success float-right text-dark"> Cetak Laporan Nilai</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
