                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Data Tingkat</h2>
                                ...
                                <div class="card">
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <!-- panggil query -->
                                                <?php $dt = get_alltingkat($db); ?>

                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0">ID Tingkat</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php while ($data = mysqli_fetch_array($dt)) { ?>
                                                        ...
                                                        <tr>
                                                            <td><?php echo $data['ID_Tingkat']; ?></td>
                                                            <td><?php echo $data['Tingkat_Kelas']; ?></td>

                                                            <td>
                                                                <a href="../admin/edit_tingkat.php?id=<?php echo $data['ID_Tingkat']; ?>" class="btn btn-primary float-right">Edit</a>
                                                                <a href="../config/cTingkat.php?hapusTingkat=<?php echo $data['ID_Tingkat']; ?>" class="btn btn-danger float-right">Hapus</a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                    <tr>
                                                        <td colspan="12">
                                                            <a href="input_tingkat.php" class="btn btn-success float-right text-dark"> <i class="fa fas fa-plus"></i> Tambah Tingkat</a>
                                                            <!-- <a href="input_tingkat.php" class="btn btn-outline-light float-right">Tambah Tingkat</a> -->
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
