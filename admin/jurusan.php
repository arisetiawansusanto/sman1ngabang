                                ...
                                <div class="card">
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <!-- panggil query -->
                                                <?php $dt = get_alljurusan($db);
                                                $no = 1; ?>

                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0">ID Jurusan</th>
                                                        <th class="border-0">Nama Jurusan</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php while ($data = mysqli_fetch_array($dt)) { ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="../admin/edit_jurusan.php?id=<?php echo $data['ID_Jurusan']; ?>" class="btn btn-primary float-right">Edit</a>
                                                                <a href="../config/cJurusan.php?hapusJurusan=<?php echo $data['ID_Jurusan']; ?>" class="btn btn-danger float-right">Hapus</a>
                                                            </td>
                                                        </tr>
                                                    <?php $no++;
                                                    } ?>
                                                    <tr>
                                                        <td colspan="12">
                                                            <a href="input_jurusan.php" class="btn btn-success float-right text-dark"> <i class="fa fas fa-plus"></i> Tambah Jurusan</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
