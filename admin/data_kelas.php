                                ...
                                <div class="card">
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <!-- panggil query -->
                                                <?php $dt = get_allkelas($db);
                                                $no = 1; ?>

                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0">No</th>
                                                        <th class="border-0">ID Kelas</th>
                                                        <th class="border-0">Nama Kelas</th>
                                                        <th class="border-0">Jumlah Murid</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php while ($data = mysqli_fetch_array($dt)) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="../admin/edit_data_kelas.php?id=<?php echo $data['ID_Kelas']; ?>" class="btn btn-primary float-right">Edit</a>
                                                                <a href="../config/cKelas.php?hapusKelas=<?php echo $data['ID_Kelas']; ?>" class="btn btn-danger float-right">Hapus</a>
                                                            </td>
                                                        </tr>
                                                    <?php $no++;
                                                    } ?>
                                                    <tr>
                                                        <td colspan="12">
                                                            <a href="input_data_kelas.php" class="btn btn-success float-right text-dark"> <i class="fa fas fa-plus"></i> Tambah Kelas</a>
                                                            <!-- <a href="input_data_kelas.php" class="btn btn-outline-light float-right">Tambah Kelas</a> -->
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
