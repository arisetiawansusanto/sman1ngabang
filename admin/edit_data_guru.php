                                ...
                                <div class="card-body mb-1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 col-lg-10">
                                            <input name="idguru" id="idguru" type="text" required="" value="<?php echo get_guru($db, $_GET['id'], 'id'); ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 col-lg-10">
                                            <input name="namaguru" id="namaguru" type="text" required="" value="<?php echo get_guru($db, $_GET['id'], 'nama'); ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 col-lg-10">
                                            <input name="alamat" id="alamat" type="text" required="" value="<?php echo get_guru($db, $_GET['id'], 'alamat'); ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 col-lg-10">
                                            <input name="email" id="email" type="text" required="" data-parsley-type="email" value="<?php echo get_guru($db, $_GET['id'], 'email'); ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 col-lg-10">
                                            <input name="telp" id="telp" type="text" required="" value="<?php echo get_guru($db, $_GET['id'], 'telp'); ?>" class="form-control">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <button class="btn btn-lg btn-primary btn-block" id="btnedit3" type="submit" name="btnedit3" value="<?php echo get_guru($db, $_GET['id'], 'id'); ?>">Save</button>
