    ...
    <div class="dashboard-main-wrapper">
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.html">SMA 1 NGABANG</a>
                                ...
                                <div class="card-body mb-1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 col-lg-10">
                                            <input autocomplete name="idmurid" id="idmurid" type="text" required="" placeholder="ID" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 col-lg-10">
                                            <input name="namamurid" id="namamurid" type="text" required="" placeholder="Nama" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-lg btn-primary btn-block" type="submit" name="btnmurid" id="btnmurid" value="btnmurid">Save</button>
