    ...
    <div class="dashboard-main-wrapper">
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.php">SMA 1 NGABANGasdasdASDA</a>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Data Akademik</h2>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php while ($data = mysqli_fetch_array($dt)) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="../admin/edit_akademik.php?id=<?php echo $data['id']; ?>" class="btn btn-primary float-right">Edit</a>
                                                                <a href="../config/cAkademik.php?hapusAkademik=<?php echo $data['id']; ?>" class="btn btn-danger float-right">Hapus</a>
                                                            </td>
                                                        </tr>
                                                    <?php $no++;
                                                    } ?>
                                                    <tr>
                                                        <td colspan="12">
                                                            <a href="input_akademik.php" class="btn btn-success float-right text-dark"> <i class="fa fas fa-plus"></i> Tambah Akademik</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
