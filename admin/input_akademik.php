                        ...
                        <div class="mt-5">
                            <div class="card mt-5">
                                <div class="card-body mb-1">
                                    <h1 class="h3 mb-3 font-weight-normal text-center">Form Input Akademik</h1>
                                    <div class="form-group row">
                                        <label for="tahun" class="col-3 col-lg-2 col-form-label text-right">Tahun</label>
                                        <div class="col-9 col-lg-10">
                                            <input autocomplete="off" id="tahun" name="tahun" type="text" required="" placeholder="Tahun" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="tahun" class="col-3 col-lg-2 col-form-label text-right">Semester</label>
                                        <div class="col-9 col-lg-10">
                                            <input autocomplete="off" name="semester" type="text" required="" placeholder="Semester" class="form-control">
                                        </div>
                                    </div>

                                    <button class="btn btn-lg btn-primary btn-block" type="submit" name="btnakademik">Save</button>
