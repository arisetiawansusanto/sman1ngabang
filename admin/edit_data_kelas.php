                        ...
                        <div class="mt-5">
                            <div class="card mt-5">
                                <div class="card-body mb-1">
                                    ...
                                    <h1 class="h3 mb-3 font-weight-normal text-center">Form Edit Data Kelas</h1>

                                    <div class="form-group row">
                                        <label for="kelas" class="col-3 col-lg-2 col-form-label text-right">Kelas</label>
                                        <div class="col-9 col-lg-10">
                                            <input id="kelas" name="kelas" type="text" required="" value="<?php echo get_kelas($db, $_GET['id'], 'kelas'); ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 col-lg-10">
                                            <input id="jumlahmurid" name="jumlahmurid" type="text" required="" value="<?php echo get_kelas($db, $_GET['id'], 'jumlah_murid'); ?>" class="form-control">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <button class="btn btn-lg btn-primary btn-block" type="submit" id="btneditkelas" value="<?php echo get_kelas($db, $_GET['id'], 'id_kelas'); ?>" name="btneditkelas">Save</button>
