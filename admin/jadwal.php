                                ...
                                <div class="card">
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <!-- panggil query -->
                                                <?php $dt = get_alljadwal($db);
                                                $no = 1; ?>

                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0">No</th>
                                                        <th class="border-0">ID Jadwal</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php while ($data = mysqli_fetch_array($dt)) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php if ($data['Waktumulai'] == '00:00:00') {
                                                                    echo '--';
                                                                } else {
                                                                    echo date('h:i', strtotime($data['Waktumulai']));
                                                                }; ?></td>
                                                            <td><?php if ($data['Waktuselesai'] == '00:00:00') {
                                                                    echo '--';
                                                                } else {
                                                                    echo date('h:i', strtotime($data['Waktuselesai']));
                                                                }; ?></td>
                                                            <td>
                                                                <a href="../admin/edit_jadwal.php?id=<?php echo $data['ID_Jadwal']; ?>" class="btn btn-primary float-right">Edit</a>
                                                                <a href="../config/cJadwal.php?hapusJadwal=<?php echo $data['ID_Jadwal']; ?>" class="btn btn-danger float-right">Hapus</a>
                                                            </td>
                                                        <tr>
                                                        <?php $no++;
                                                    } ?>
                                                        <td colspan="12">
                                                            <a href="input_jadwal.php" class="btn btn-success float-right text-dark"> <i class="fa fas fa-plus"></i> Tambah Jadwal</a>
                                                        </td>
                                                        </tr>
                                                </tbody>
                                            </table>
