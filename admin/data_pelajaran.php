                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Data Pelajaran</h2>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php while ($data = mysqli_fetch_array($dt)) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="../admin/edit_data_pelajaran.php?id=<?php echo $data['ID_Pelajaran']; ?>" class="btn btn-primary float-right">Edit</a>
                                                                <a href="../config/cPelajaran.php?hapusPelajaran=<?php echo $data['ID_Pelajaran']; ?>" class="btn btn-danger float-right">Hapus</a>
                                                            </td>
                                                        </tr>
                                                    <?php $no++;
                                                    } ?>
                                                    <tr>
                                                        <td colspan="12">
                                                            <a href="input_data_pelajaran.php" class="btn btn-success float-right text-dark"> <i class="fa fas fa-plus"></i> Tambah Pelajaran</a>
                                                            <!-- <a href="input_data_pelajaran.php" class="btn btn-outline-light float-right">Tambah Pelajaran</a> -->
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
